...
from app.core.errors import CONFLICT, FORBIDDEN, NOT_FOUND, VALIDATION_ERROR, ApiError
...
def test_factories_follow_the_api_error_envelope(factory, code: str, message: str) -> None:
